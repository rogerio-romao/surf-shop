...
/* 
	Create a new async method called landingPage
	and add it to the module.exports object 
*/
// GET /
...
```
- Update the boilerplate layout to include mapbox CDN's (/views/layouts/boilerplate.ejs)
```HTML
<!DOCTYPE html>
<html>
  <head>
